      ...
      <div class="flex-1 flex bg-base-200 justify-center items-start py-8">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-md overflow-hidden flex">
          ...
          <div class="flex-1 p-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Keamanan & Privasi</h1>
            
            <!-- Password Update Section -->
            <div class="border-b border-gray-200 pb-6">
              <h2 class="text-lg font-medium text-gray-800 mb-4">Ganti Password</h2>
              ...
              <form method="POST" action="{{ route('settings.security.update') }}">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-end pt-2">
                    <button type="submit" 
                            class="px-4 py-2 bg-primary text-white rounded-3xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                      Update Password
                    </button>
                  </div>
                </div>
