      ...
      <div class="flex-1 flex bg-base-200 justify-center items-start py-8">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-md overflow-hidden flex">
          ...
          <div class="flex-1 p-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Preferensi & Tampilan</h1>
            
            <!-- Password Update Section -->
            <div class="border-b border-gray-200 pb-6">
              <h2 class="text-lg font-medium text-gray-800 mb-4">Sesuaikan dengan keinginan anda!</h2>
              ...
              <div class="p-8 rounded shadow-md w-full max-w-md">
                ...
                <p class="text-sm text-base-content mt-6 text-center dark:text-gray-800">
